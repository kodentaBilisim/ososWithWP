						...
						foreach ( $kayitlar as $value ): ?>
							...
							<?php if ( $value['status'] == 0 ): ?>
                                <div class="alert alert-warning" role="alert">
                                    ...
                                    eklenen <?= ( $value['type'] == 'kayit' ) ? ' üye listesi' : (( $value['type'] == 'istifa' ) ? ' istifa listesi' : 'hesap dökümü') ?> <?= $i ?>
							...
							<?php else: ?>
                                <div class="alert alert-info" role="alert">
                                    ...
                                    eklenen <?= ( $value['type'] == 'kayit' ) ? ' üye listesi' : (( $value['type'] == 'istifa' ) ? ' istifa listesi' : 'hesap dökümü') ?>
                                    işleniyor...
                                </div>
							<?php endif; ?>
                    ...
                    <div class="card-body">
						...
						foreach ( $kayitlar as $value ):
                            ...
                            <div class="alert alert-success" role="alert">
                                ...
                                eklenen <?= ( $value['type'] == 'kayit' ) ? ' üye listesi' : (( $value['type'] == 'istifa' ) ? ' istifa listesi' : 'hesap dökümü') ?>. <br><br><a role="button" class="btn btn-warning"
                                                                                                                             href="?page=uye/islem-details&id=<?= $value['id'] ?>" target="_blank">Ayrıntılar için
                                    tıklayınız!</a>
