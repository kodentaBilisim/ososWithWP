        ...
        <div class="col-lg-12">
            ...
            <div class="row">
                ...
                <?php if ($islem['type'] == 'kayit'):
                    ...
                    $uyelerİslem = $db->from('kisiler')->where('createDateTime', date('Y-m-d H:i:s', $islemDate))->all();
                ...
                $istifaİslem = $db->from('kisiler')->where('durum', 0)->where('updateTime', json_decode($islem['data'], true)['uploadDateTime'])->all();

                var_dump($istifaİslem);
            ...
            <?php elseif ($islem['type'] == 'hesap'):?>
                            ...
                            <div class="card-body">
                                <div class="card-body">
                                    <table id="personel"
                                        ...
                                        $i = 0;
                                        foreach ($db->from('odemeler')->where('rand', $islemDate)->all() as $islem) {
                                            ...
                                            $uye = kisiGetirSingle($islem['user']);
                ...
                <div class="row">
                    <div class="col-xxl-12 col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">EŞLEŞMEYEN ÖDEMELER</h5>
                            </div>
                            <div class="card-body">
                                <div class="card-body">
                                    <table id="personel"
                                        ...
                                        $i = 0;
                                        foreach ($db->from('odemeler')->where('rand', $islemDate)->where('user', 0)->all() as $islem) {

                                            $islemData = json_decode($islem['data'],true);
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a target="_blank"
                                                       href="?page=uye/islem-eslestir&id=<?= $islemData['O'] ?>"
                                                       class="btn btn-info  ">EŞLEŞTİR
                                                    </a>
