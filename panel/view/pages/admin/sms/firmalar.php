                                    ...
                                    <table id="example"
										...
										foreach ( $Firmalar as $veri ) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="?page=sms/firmalar&firma=<?php echo $UserListId; ?>"
                            ...
                            <div class="card-body">
                                ...
                                <div class="position-relative form-group">
									...
									foreach ( $array as $veri ) {
										...
										echo '<div class="position-relative fir temsilcisecildi form-check"><label class="form-check-label"><input value="0" name="' . $veri['id'] . '" type="checkbox" class="form-check-input firma">' . $veri['sgk'] . '('.ilgetirbyID($veri['il']).')' . '<pre>' . str_replace( '    ', '', $veri['adres'] ) . '</pre>' . '</label></div>';
