            ...
            <div class="col-md-6">
                <form method="post" action="" enctype="multipart/form-data" id="subeler">
                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            <h5 class="card-title">İl Seçiniz
                                <div></div>
                            </h5>
                            <div class="position-relative form-group">
								...
								foreach ( ilgetir() as $v => $j ) {

									echo '<div class="position-relative form-check"><label class="form-check-label"><input value="0" name="' . $v . '" type="checkbox" class="form-check-input sube">' . $j . '</label></div>';
