<div class="page-content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">GENEL ÜYE BİLGİLERİ</h4>
            ...
            <div class="col-12">
			    ...
			    $uye = $db->from( 'kisiler' )->where( 'durum', 1 )->all();
        ...
        <div class="row">
            ...
            foreach (json_decode($_SESSION['yetki'],true) as $il ): ?>
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0"><?=ilgetirbyID($il)?></h4>
		            ...
		            $uye = $db->from( 'kisiler' )->where('il',$il)->where( 'durum', 1 )->all();
