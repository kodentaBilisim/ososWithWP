                    ...
                    <div class="card-body">
                        <table id="personel"
                            ...
                            foreach ($ilUye as $personel):
                                ...
                                if(!in_array($personelData['il'],json_decode($_SESSION['yetki'],true))){
                                    continue;
                                }
                                ...
                                <tr>
                                    ...
                                    <td><?= $talimatData['amount'] ?> TL</td>



                                    <td data-sort="<?= $talimatData['date'] ?>"><?= date('d.m.Y H:i:s', $talimatData['date']) ?></td>
                                    <td><?= $talimatData['day'] ?></td>
