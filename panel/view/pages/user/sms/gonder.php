        ...
        <section>
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    <a href="/api/sms/cinsiyet.php?cinsiyet=K&id=<?php echo $_GET['kampanya'] ?>" type="button"
                       class="btn btn-primary btn-min-width ">KADINLAR</a>
                    <a href="/api/sms/cinsiyet.php?cinsiyet=E&id=<?php echo $_GET['kampanya'] ?>" type="button"
                       class="btn btn-info btn-min-width mx-1">ERKEKLER</a>
                    <a href="/api/sms/cinsiyet.php?cinsiyet=all&id=<?php echo $_GET['kampanya'] ?>" type="button"
                       class="btn btn-success btn-min-width mr-1">TÜM LİSTELENENLER</a>
                    <a href="sms/kisilistesi?kampanya=<?php echo $_GET['kampanya'] ?>" target="_blank"
                                        ...
                                        <div class="col-md-6">
                                            <ul class="list-group list-group-flush">
												...
												<?php foreach ( $KampanyaFilter['firmalar'] as $sube ) {
                                                    ...
                                                    ?>
                                                    <li class="list-group-item">
														<?php echo sgk_meta($sube)['sgk'] . '<pre>' . str_replace( '    ', '', sgk_meta($sube)['adres'] ) . '</pre>'; ?>
                                                    </li>
												<?php } ?>
                                            </ul>
                                        </div>
