                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="example" class="table table-bordered dt-responsive table-striped align-middle"
							...
							$FirmaList = $db->from( 'sgk' )->in('il',json_decode($_SESSION['yetki'],true))->all();
                            $checkFirma = [];

							foreach ( $FirmaList as $Firma ) {
								$FirmaMeta = sgk_meta($Firma['id']);
                                if(in_array($Firma['firma'],$checkFirma)){
                                    continue;
                                }else{
                                ...
                                <tr>
                                    <td><?= $FirmaMeta['name'] ?></td>

                                    <td>
                                        <a class="btn btn-success" role="button"
                                           href="?page=firma/duzenle&id=<?= $Firma['firma'] ?>">AYRINTI</a>
                                    </td>
