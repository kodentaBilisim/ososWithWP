		...
		<div class="row">
								...
								while ( $the_query->have_posts() ) {
									...
									<div class="carousel-item <?php if($k == 0){echo 'active';} $k++; ?>">
										<a href="<?php the_permalink(); ?>" style="text-decoration: none; color: inherit;">
											<img class="d-block w-100 mansetimg" src="<?php echo gorsel($post->ID);?>" alt="<?php the_title(); ?>">
										</a>
			...
			<div class="col-md-3 col-12">
				...
				<div class="socialmedia mt-1 mt-md-0">
					<ul class="labels">
						<li><a href="https://www.facebook.com/tekgida" target="_blank"><img src="<?php bloginfo('template_url'); ?>/img/facebook.png"></a></li>
						<li><a href="https://twitter.com/tekgida" target="_blank"><img src="<?php bloginfo('template_url'); ?>/img/twitter.png"></a></li>
						<li><a href="http://instagram.com/tekgidais" target="_blank"><img src="<?php bloginfo('template_url'); ?>/img/instagram.png"></a></li>
						<li><a href="https://www.youtube.com/channel/UC7mb8F2I5Qacri_uev1Ajbg" target="_blank"><img src="<?php bloginfo('template_url'); ?>/img/youtube.png"></a></li>
						<li><a href="https://www.linkedin.com/company/tekg%C4%B1da-i%C5%9F-sendikas%C4%B1/" target="_blank"><img src="<?php bloginfo('template_url'); ?>/img/linkedin.png"></a></li>
				...
				<div class="baskandan">
					<div class="baskandan-content">
						...
						<h5 class="text-center mt-2">SENDİKA AKADEMİSİ</h5>
								...
								<?php
									...
									if ( $the_query->have_posts() ) {
										...
										<div class="carousel-item <?php if($i == 0){echo 'active';} $i++; ?>">
											<a href="<?php the_permalink(); ?>" style="text-decoration: none; color: inherit;">
												<img class="d-block w-100 baskandanimg" src="<?php echo get_the_post_thumbnail_url($post->ID, 'full'); ?>" alt="<?php the_title(); ?>">
											</a>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-9 col-12">
				...
				<div class="widget">
					<div class="widget-title degrade"><a href="category/bildiri-ve-haberler/tis-haberleri" style="text-decoration: none; color: inherit;">
						TİS HABERLERİ
					</a>
					</div>
						...
						<?php
							...
							if ( $the_query->have_posts() ) {
								...
								while ( $the_query->have_posts() ) {
									...
									$title = get_the_title();
									if ( has_excerpt() ) {$excerpt = get_the_excerpt(); }else{ $excerpt = ''; }
			...
			<div class="col-12">
				...
				<div class="widget">
					<div class="widget-title degrade">
						<a href="category/bildiri-ve-haberler/genel-baskandan" style="text-decoration: none; color: inherit;">GENEL BAŞKANDAN
						</a></div>
						<div class="widget-content">
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				...
				<div class="widget">
					<div class="widget-title degrade">
						<a href="category/bildiri-ve-haberler/egitim-haberleri" style="text-decoration: none; color: inherit;">
							EĞİTİM HABERLERİ
						</a>
					</div>
					<div class="widget-content">
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				...
				<div class="widget">
					<div class="widget-title degrade">
						<a href="category/bildiri-ve-haberler/orgutlenme-grev-ve-eylemlerden-haberler" style="text-decoration: none; color: inherit;">
...
<section>
	<div class="container">
		<div class="row">
			<div class="col-12">
				<div class="widget">
					<div class="widget-title degrade">FOTO GALERİ</div>
									...
									if($query->have_posts()) {
										...
										<div class="carousel-item <?php if($i == 0){ echo 'active'; $i++;} ?>">
											<a href="<?php echo $link;?>" target="_blank" >
												<img style="max-height: 468px;" class="d-block w-100" src="<?php echo get_the_post_thumbnail_url($post->ID, 'full'); ?>" alt="<?php the_title(); ?>">
												<div class="carousel-caption">
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					...
					<div class="widget">
						<div class="widget-title degrade">TEKGIDA TV</div>
										...
										while ( $the_query->have_posts() ) {
											...
											<div class="col-12 col-md-9" onclick="modalopen(<?php echo $post->ID ?>);">
												...
												<div class="widget-items video d-none d-md-block">
													...
													<img style="width: 100%;
object-fit: cover;
max-height: 450px;" class="img-fluid videopoint" src="https://i1.ytimg.com/vi/<?php echo $videocode2; ?>/hqdefault.jpg" alt="<?php the_title(); ?>">
												...
												<div class="widget-items video mb-1 d-block d-md-none">
													<div class="row p-0 m-0">
														...
														<div class="col-12 p-0 m-0">
															<img class="img-fluid videopoint" src="https://i1.ytimg.com/vi/<?php echo $videocode2; ?>/hqdefault.jpg" alt="<?php the_title(); ?>">
										...
										<div class="col-12 col-md-3">
											...
											<div class="widget-items video mb-1" onclick="modalopen(<?php echo $post->ID ?>);">
												<div class="row p-0 m-0">
													...
													<div class="col-12 p-0 m-0">
														<img class="img-fluid w-100  h146" src="https://i1.ytimg.com/vi/<?php echo $videocode2; ?>/hqdefault.jpg" alt="<?php the_title(); ?>">
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				...
				<div class="widget">
					<div class="widget-title degrade">
						<a href="category/bildiri-ve-haberler/uluslararasi-iliskiler" style="text-decoration: none; color: inherit;">ULUSLARARASI İLİŞKİLER
						</a></div>
						<div class="widget-content">
							...
							<div class="row">
								...
								<div class="widget">
								<div class="widget-title degrade">
								<a href="category/bildiri-ve-haberler/kadin-komisyonu" style="text-decoration: none; color: inherit;">KADIN KOMİSYONU
								</a></div>
								<div class="widget-content">
								...
								<div class="widget">
								<div class="widget-title degrade">
								<a href="category/bildiri-ve-haberler/sosyal-guvenlik-kosesi" style="text-decoration: none; color: inherit;">
